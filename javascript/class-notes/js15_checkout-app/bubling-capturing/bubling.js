...
//! Event 'ın olmasını sağlayan nn içteki element "target element" olarak adlandirilir ve event.target ile erisilebilir.

document.querySelector("form").onclick = function (event) {
  console.log(event.target) //? event kaynagı
